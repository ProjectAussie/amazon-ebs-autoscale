...
EV uses their own Centos based AMI with slight differences from the alinux2 AMI this was originally designed for. The differences are highlighted below and the scripts underpinning the service have been updated to accommodate:
